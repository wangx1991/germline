...
parser = argparse.ArgumentParser(usage = "\n\npython %(prog)s --source --sample_name  --output  --memorySize --gatk_dir  --ref_fa_file --exome_target --ERC --samtools_dir --read_filter --reduce_logs --create_output_variant_index ")
